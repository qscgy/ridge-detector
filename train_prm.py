...
from wise_ils.datasets import pascal2012
os.environ['TORCH_MODEL_ZOO'] = '/mnt/projects/counting/pretrained/resnet'
from wise_ils import models, datasets, metrics
from wise_ils import utils as ut
import tqdm, time
import pandas as pd
...
def main():
    ...
    train_set = datasets.pascal2012.Pascal2012(split="train", exp_dict=exp_dict,
                                               root="/bigpen/VOC2012/VOCdevkit/VOC2012/")
    ...
    exp_dict["dataset"] = pascal2012

    model = models.prm.PRM(**exp_dict).cuda()
